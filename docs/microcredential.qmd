...
format: 
  html:
    theme: [spacelab, custom.css, styles.scss]
    toc: true
    toc-location: left
    reference-location: document
---
::: {layout="[[30, 70], [100]]"}
![Prof.Dr. Niaz Akhtar, VC QAU](images/vc_qau.jpg){width="50%"}
...
::: {layout="[[30, 70], [100]]"}
![Zahid Asghar, https://zahedasghar.netlify.app](images/424_zahid.jpg){width="50%"}
